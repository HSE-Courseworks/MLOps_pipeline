...
sudo rm -rf FastAPI-app/.pytest_cache \
            FastAPI-app/__pycache__ \
            FastAPI-app/app/__pycache__  \
            airflow/plugins \
            airflow/config \
            airflow/dags/__pycache__ \
            airflow/logs \
            airflow/dags/telegram_feature \
            airflow/dags/mlflow_experiments \
            airflow/dags/reactions_model \
            telegram_feature/__pycache__ \
            mlflow_experiments/__pycache__ \
            airflow/dags/mlflow_experiments \
            tests/__pycache__ \
            reactions_predicting/__pycache__ \
            reactions_predicting/cluster/__pycache__ \
            reactions_predicting/Tokenize/__pycache__ 
