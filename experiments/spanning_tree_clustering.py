...
def clustering(vectors, n_clusters: int, metric=2):
    if n_clusters > len(vectors) or n_clusters<1:
        raise Exception("number of clusters can't be more than size number of elements in array or less than zero")
...
matrices = [[[1,2,3],[4,5,6]],[[152,223,3243],[37,235,124]],[[34,42,25],[42,23,98]],[[1,2,3],[0,0,0]]]
